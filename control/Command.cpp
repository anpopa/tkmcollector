    ...
    setCallback([this]() {
        for (const Command::Request &request : m_requests) {
            ...
            case Command::Action::TerminateCollector: {
                Dispatcher::Request rq {.action = Dispatcher::Action::TerminateCollector};
            ...
            case Command::Action::AddDevice: {
                ...
                rq.args.emplace(Defaults::Arg::DeviceAddress, request.args.at(Defaults::Arg::DeviceAddress));
            ...
            case Command::Action::StartDeviceSession: {
                Dispatcher::Request rq {.action = Dispatcher::Action::StartDeviceSession};
