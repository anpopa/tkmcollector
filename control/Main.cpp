...
auto main(int argc, char **argv) -> int
{
    ...
    while ((c = getopt_long(argc, argv, "hfitlarocdsxI:N:A:P:", longopts, &long_index))
           != -1) {
        switch (c) {
        case 'o':
            config_path = optarg;
    ...
    if (help) {
        ...
        cout << "     --terminateCollector, -t  <noarg>   Ask tkm-collector to terminate\n";
        cout << "  Database:\n";
        ...
        cout << "     --removeDevice,  -r       <noarg>   Remove user from database. Require:\n";
        ...
        cout << "     --disconnect, -d          <noarg>   Disconnect device from taskmonitor"
                "Require:\n";
        cout << "         --Id, -I              <string>  Device ID\n";
        cout << "     --startSession, -s        <noarg>   Start collecting data from device"
                "Require:\n";
        cout << "         --Id, -I              <string>  Device ID\n";
        cout << "     --stopSession, -x         <noarg>   Stop collecting data from device"
                "Require:\n";
        cout << "         --Id, -I              <string>  Device ID\n";
        cout << "  Help:\n";
