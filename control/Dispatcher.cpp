...
static bool doDeviceList(const shared_ptr<Dispatcher> &mgr, const Dispatcher::Request &rq);
static bool doSessionList(const shared_ptr<Dispatcher> &mgr, const Dispatcher::Request &rq);
