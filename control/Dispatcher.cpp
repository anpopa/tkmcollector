...
static auto doConnectDevice(const shared_ptr<Dispatcher> &mgr, const Dispatcher::Request &rq) -> bool;
static auto doDisconnectDevice(const shared_ptr<Dispatcher> &mgr, const Dispatcher::Request &rq) -> bool;
static auto doStartDeviceSession(const shared_ptr<Dispatcher> &mgr, const Dispatcher::Request &rq) -> bool;
static auto doStopDeviceSession(const shared_ptr<Dispatcher> &mgr, const Dispatcher::Request &rq) -> bool;
static auto doTerminateCollector(const shared_ptr<Dispatcher> &mgr, const Dispatcher::Request &rq)
    -> bool;
...
static auto doRemoveDevice(const shared_ptr<Dispatcher> &mgr, const Dispatcher::Request &rq) -> bool
{
    ...
    deviceData.set_id(rq.args.at(Defaults::Arg::DeviceId));
    requestMessage.mutable_data()->PackFrom(deviceData);
...
static auto doStartDeviceSession(const shared_ptr<Dispatcher> &mgr, const Dispatcher::Request &rq) -> bool
{
    ...
    logDebug() << "Request start collect device for: " << rq.args.at(Defaults::Arg::DeviceName);
    return ControlApp()->getConnection()->writeEnvelope(requestEnvelope);
}
...
static auto doStopDeviceSession(const shared_ptr<Dispatcher> &mgr, const Dispatcher::Request &rq) -> bool
{
    ...
    logDebug() << "Request stop collect device for: " << rq.args.at(Defaults::Arg::DeviceName);
    return ControlApp()->getConnection()->writeEnvelope(requestEnvelope);
}
...
static auto doCollectorStatus(const shared_ptr<Dispatcher> &mgr, const Dispatcher::Request &rq) -> bool
{
