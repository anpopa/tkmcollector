...
static auto doRequestSession(const shared_ptr<ControlClient> &client,
                             tkm::msg::collector::Request &rq) -> bool;
static auto doQuitCollector(const shared_ptr<ControlClient> &client,
                            tkm::msg::collector::Request &rq) -> bool;
...
static auto doDisconnectDevice(const shared_ptr<ControlClient> &client,
                               tkm::msg::collector::Request &rq) -> bool;
static auto doStartCollecting(const shared_ptr<ControlClient> &client,
                              tkm::msg::collector::Request &rq) -> bool;
static auto doStopCollecting(const shared_ptr<ControlClient> &client,
                             tkm::msg::collector::Request &rq) -> bool;
